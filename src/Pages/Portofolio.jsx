...
export default function FullWidthTabs() {
    ...
    return (
        ...
        >
            ...
            >
                <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto bg-clip-text bg-[#14B8A6]">
                    <span
                        style={{
                            color: "#14B8A6",
                ...
                <p className="text-[#94A3B8] max-w-2xl mx-auto text-sm md:text-base mt-2">
                    A collection of selected projects across web, mobile, and
                    game development, showcasing practical solutions, clean
                ...
                <AppBar
                    ...
                    sx={{
                        ...
                        "&::before": {
                            ...
                            bottom: 0,
                            background:
                                "linear-gradient(180deg, rgba(20, 184, 166, 0.06) 0%, rgba(45, 212, 191, 0.06) 100%)",
                        ...
                        sx={{
                            ...
                            "& .MuiTab-root": {
                                ...
                                "&.Mui-selected": {
                                    color: "#ffffff",
                                    background:
                                        "linear-gradient(135deg, rgba(20, 184, 166, 0.22), rgba(45, 212, 191, 0.22))",
                                    boxShadow:
                                        "0 4px 15px -3px rgba(20, 184, 166, 0.35)",
                                    "& .lucide": {
                                        color: "#2DD4BF",
                                    },
                                },
