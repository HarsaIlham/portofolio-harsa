...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formSubmitUrl =
        "https://formsubmit.co/harsailham05@gmail.com";
    ...
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] ">
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        <p
          ...
          className="text-[#94A3B8] max-w-2xl mx-auto text-sm md:text-base mt-2"
        >
        ...
        <div className="container px-[1%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-12">
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl p-5 py-10 sm:p-10 transform transition-all duration-500 hover:shadow-[#6366f1]/10">
            <div className="flex justify-between items-start mb-8">
              <div>
                <h2 className="text-4xl font-bold mb-3 text-transparent bg-clip-text bg-white">
                  Hubungi
                </h2>
                <p className="text-[#94A3B8]">
                  Ada yang ingin didiskusikan? Kirim saya
                  pesan dan mari kita bicara.
                </p>
              </div>
              <Share2 className="w-10 h-10 text-[#14B8A6]" />
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                type="submit"
                disabled={isSubmitting}
                className="w-full bg-gradient-to-r from-[#14B8A6] to-[#0D9488] text-white py-4 rounded-xl font-semibold
                flex items-center justify-center gap-2 transition-all duration-300 ease-out hover:-translate-y-[3px] hover:brightness-110
                hover:shadow-[0_12px_40px_rgba(20,184,166,0.35)] active:translate-y-0 active:shadow-none disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0"
              >
