...
const socialLinks = [
    {
        ...
        subText: "on LinkedIn",
        icon: Linkedin,
        url: "https://www.linkedin.com/in/harsailham/",
        color: "#0A66C2",
    ...
    },
    {
        ...
        subText: "@harsa_ilham",
        icon: Instagram,
        url: "https://www.instagram.com/harsa_ilham/?hl=id",
        color: "#E4405F",
    ...
    },
    {
        ...
        subText: "@HarsaIlham",
        icon: Github,
        url: "https://github.com/HarsaIlham",
        color: "#ffffff",
    ...
    return (
        <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
            <h3
                ...
                data-aos="fade-down"
            >
                <span className="inline-block w-8 h-1 bg-[#14B8A6] rounded-full"></span>
                Connect With Me
            </h3>
